  <?php include('header.php'); ?>
    ...
    <?php
      while($row = $executar->fetch_object())
      {
        ...
        {
          $botoes = "<p><a class='waves-effect waves-light red accent-4 btn' href=ver_quarto.php?idquarto_del=".$codquarto.">Excluir</a> <a class='waves-effect waves-light blue btn' href=alteracao_quarto.php?idquarto=".$codquarto.">Alterar</a></div></div></div>";
        }
        else
        {
